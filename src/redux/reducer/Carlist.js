import {
  ACTIVITY_CARLIST_FILTER_ALL,
  ACTIVITY_CARLIST_FILTER_LARGE,
  ACTIVITY_CARLIST_FILTER_MEDIUM,
  ...
  ACTIVITY_ORDERTABLE_REDUCER_FULFILLED,
  ACTIVITY_ORDERTABLE_REDUCER_PENDING,
  ACTIVITY_ORDERTABLE_REDUCER_REJECT,
  ACTIVITY_ORDERTABLE_REDUCER_SETCURRENT_PAGE,
  ACTIVITY_ORDERTABLE_REDUCER_SETPAGE,
...
export function filterStateReducer(state = filterState, action) {
  switch (action.type) {
    ...
    case ACTIVITY_CARLIST_FILTER_SMALL:
      return { ...state, category: "small" };
    case ACTIVITY_CARLIST_FILTER_MEDIUM:
      return { ...state, category: "medium" };
    case ACTIVITY_CARLIST_FILTER_LARGE:
      return { ...state, category: "large" };
    default:
      return state;
  }
}
...
export function orderTableStateReducer(state = orderTableState, action) {
  switch (action.type) {
    ...
    case ACTIVITY_ORDERTABLE_REDUCER_FULFILLED:
      return { ...state, isLoading: false, data: action.data, pageSize: action.pageSize };
