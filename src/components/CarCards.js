...
const Cards = ({ cars, filterByCategory, onDelete }) => {
  if (cars.length === 0) return <p>gada</p>;
  console.log(cars);
  return cars
...
// import { message } from "antd";
// import { useDispatch, useSelector } from "react-redux";
// import { searchPayloadSearchCars, selectSearchCars, fetchSearchCars, setPayload } from "../store/features/searchCarSlicing";
...
//   console.log(searchCarsData.data);
...
//     setFilterByCategory("small");
//     setIsActive(isActive);
//     // dispatch(setPayload({ ...payload, category: "small" }));
//   }
//   function showMedium() {
//     setFilterByCategory("medium");
//     setIsActive(isActive);
//     // dispatch(setPayload({ ...payload, category: "medium" }));
//   }
//   function showLarge() {
//     setFilterByCategory("large");
//     setIsActive(isActive);
//     // dispatch(setPayload({ ...payload, category: "large" }));
//   }
...
//         </div>
//         <div key="id" className="card-group">
//           <Cards cars={searchCarsData.data} filterByCategory={filterByCategory} onDelete={onDelete} />
//         </div>
//         <Modal className="modal" show={modalOpen} animation={true} centered>
//           <ModalBody className="modal-body">
//             <div className="modal-content">
